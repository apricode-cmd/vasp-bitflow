...
export const AUDIT_ACTIONS = {
  ...
  KYC_DOCUMENTS_SYNCED: 'KYC_DOCUMENTS_SYNCED',
  ...
  MANUAL_RATE_DELETED: 'MANUAL_RATE_DELETED',
  ...
  ADMIN_PASSKEY_REMOVED: 'ADMIN_PASSKEY_REMOVED',
