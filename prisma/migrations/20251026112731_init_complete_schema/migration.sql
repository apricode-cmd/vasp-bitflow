...
-- AddForeignKey
ALTER TABLE "PayIn" ADD CONSTRAINT "PayIn_fiatCurrency_fkey" FOREIGN KEY ("currency") REFERENCES "FiatCurrency"("code") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayIn" ADD CONSTRAINT "PayIn_cryptocurrency_fkey" FOREIGN KEY ("currency") REFERENCES "Currency"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PayOut" ADD CONSTRAINT "PayOut_cryptocurrency_fkey" FOREIGN KEY ("currency") REFERENCES "Currency"("code") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayOut" ADD CONSTRAINT "PayOut_fiatCurrency_fkey" FOREIGN KEY ("currency") REFERENCES "FiatCurrency"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
