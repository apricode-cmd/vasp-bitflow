...
async function main(): Promise<void> {
  ...
  const notificationEvents = [
    ...
    },
    {
      ...
      name: 'Order Expired',
      description: 'Order has expired due to timeout',
      category: 'ORDER' as const,
      channels: ['EMAIL', 'IN_APP'] as const,
      priority: 'NORMAL' as const,
      isSystem: true,
    ...
    {
      eventKey: 'SECURITY_2FA_DISABLED',
      name: '2FA Disabled',
    ...
    // ADMIN EVENTS
    {
      eventKey: 'ADMIN_INVITED',
      name: 'Admin Invited',
      description: 'Admin user has been invited to the platform',
